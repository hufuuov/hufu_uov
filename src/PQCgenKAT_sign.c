...
#define CRYPTO_SECRETKEYBYTES  HUFU_UOV_SK_SIZE
#define CRYPTO_PUBLICKEYBYTES  HUFU_UOV_PK_SIZE
#define CRYPTO_BYTES           HUFU_UOV_SIGNATURE_SIZE

#define CRYPTO_ALGNAME "hufu_uov_128bit_security"
...
main()
{
    ...
    do {
       ...
       // fprintBstr(fp_rsp, "pk = ", pk, CRYPTO_PUBLICKEYBYTES);
        ...
        if ( (ret_val = crypto_sign_open(m1, &mlen1, sm, smlen, pk)) != 1) {
